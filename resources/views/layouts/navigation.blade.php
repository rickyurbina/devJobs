            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @can('create', App\Models\Vacante::class)
                        ...
                        <a class="mr-2 w-7 h-7 bg-indigo-500 hover:bg-indigo-800 rounded-full flex flex-col 
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if ( auth()->user()->rol === 2 )
                    <div class="flex gap-2 items-center p-3">
                        {{-- Notificaciones en la vsiat del movil --}}
                        <a class="w-7 h-7 bg-indigo-500 hover:bg-indigo-800 rounded-full flex flex-col 
                            justify-center items-center text-sm font-extrabold text-white" 
                            href="{{ route('notificaciones') }}"> 

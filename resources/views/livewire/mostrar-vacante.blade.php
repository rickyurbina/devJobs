<div class="p-10">
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                Deseas postularte? <a class="font-bold text-indigo-600 " href=" {{ route('register') }}"> Obten una cuenta y aplica para esta y muchas otras vacantes!</a>
            </p>
        </div>    
    @endguest

    {{-- Esta directiva sirve para limitar a los reclutadores para ver el formulario que llenaran los solicitantes
        cuando les interesa una vacante y toma las funciones del Policy en este caso 'create' --}}
